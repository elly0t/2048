...
A playable 2048 with a local AI assistant. React + TypeScript + Vite, tested with Vitest and Playwright. The assistant runs an Expectimax search (default depth 3) entirely in the browser — no backend, no network calls.
